...
local R15PartTransparency = _G.R15PT -- true/false
local R6PartTransparency = _G.R6PT -- true/false
local Target = _G.Target -- game.Players:WaitForChild("OtherPlayerName")
--
