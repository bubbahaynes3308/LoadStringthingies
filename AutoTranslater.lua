...
--]]
loadstring(game:HttpGet("https://raw.githubusercontent.com/Pixeluted/adoniscries/refs/heads/main/Source.lua",true))() --This Is Just so That Adonis Doesnst Kick you when Auto Translator is running
...
game:GetService("StarterGui"):SetCore("SendNotification",
    {
        ...
        Text = "you can find the list of languages in the github OR the script",
        Duration = 3
    }
)
                  
properties.Text = "To send messages in your language, press > and then type in the language code. For example after typing >ru you would now be able to talk in Russian. To go back, say >d. To type in your own language into English, say >auto."
...
function disableSend()
    sendEnabled = false
    properties.Text = "You've disabled the translator."
    StarterGui:SetCore("ChatMakeSystemMessage", properties)
end
                ...
                if Enter ~= false and Bar.Text ~= '' then
                    ...
                    elseif Message:sub(1,1) == ">" and not Message:find(" ") then
                        if getISOCode(Message:sub(2)) then
                            ...
                            properties.Text = "Are you sure that is the correct language?"
                            StarterGui:SetCore("ChatMakeSystemMessage", properties)
                        end
